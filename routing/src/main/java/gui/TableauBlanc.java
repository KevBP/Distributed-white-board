...
public class TableauBlanc extends JPanel {
    ...
    private FormePaintedListener formePaintedListener;
    /**
     ...
     * Constructeur.
     */
    public TableauBlanc(FormePaintedListener listener) {
        super(true);
        formePaintedListener = listener;
    }

    /**
     * Méthode de dessin.
     *
     * @param g Le contexte de le dessin.
     */
    ...
    public void delivreForme(Forme forme, boolean dispatch) {
        ...
        if (dispatch && formePaintedListener != null) {
            formePaintedListener.onPaint(forme);
        }
    }
    ...
    public void delivreForme(Forme forme) {
        delivreForme(forme, true);
    }

    /**
     * Démarre une selection.
     *
     * @param forme la forme à renseigner.
     * @param sl    L'écouteur de selection.
     */
    ...
    public void setFormePaintedListener(FormePaintedListener listener) {
        this.formePaintedListener = listener;
    }
    ...
    private static class SelectionThread extends Thread implements
         ...
         * Démarre une selection.
         *
         * @param proprio Le composant propriétaire.
         * @param sl      L'écouteur de selection.
         * @param forme   la forme à renseigner.
         */
